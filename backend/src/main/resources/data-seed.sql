...
(1,'MIRADOR HOTEL YAOUNDE','Hôtellerie de Luxe','+237 222 33 44 55','YAOUNDE','M0123456789'),
...
('Cameroun'), ('Tchad'), ('Gabon'), ('Congo'), ('RCA'), ('Guinée Équatoriale'), ('Nigeria'), ('Bénin'), ('Togo'), ('Sénégal'),
('Côte d\'Ivoire'), ('Mali'), ('Niger'), ('Burkina Faso'), ('Guinée'), ('Ghana'), ('Angola'), ('Maroc'), ('Tunisie'), ('Égypte'),
('Éthiopie'), ('Kenya'), ('Afrique du Sud'), ('Rwanda'), ('RD Congo');
...
('4111','Clients Hôtel','Actif','CLASSE 4',850000,'Actif'),
('4112','Clients Société','Actif','CLASSE 4',2300000,'Actif'),
('5211','BICEC Yaoundé','Actif','CLASSE 5',5000000,'Actif'),
('5212','ECOBANK N\'Djamena','Actif','CLASSE 5',3500000,'Actif'),
('5213','UBA Douala','Actif','CLASSE 5',1200000,'Actif'),
('5711','Caisse Réception','Actif','CLASSE 5',150000,'Actif'),
...
('6051','ENEO Électricité','Charge','CLASSE 6',185000,'Actif'),
...
('7011','Ventes Hébergement','Produit','CLASSE 7',12500000,'Actif'),
...
('4431','État TVA Facturée','Passif','CLASSE 4',150000,'Actif'),
('4432','État TVA Récupérable','Actif','CLASSE 4',45000,'Actif'),
('5121','Banque CBC','Actif','CLASSE 5',900000,'Actif'),
('1061','Réserves','Passif','CLASSE 1',500000,'Actif');
...
('Foléré Glacé','JUS',2000,500,3,100), ('Jus de Gingembre','JUS',2500,500,3,80), ('Eau Tangui 1.5L','EAU',4000,600,3,120), ('Eau Mayo 1.5L','EAU',3800,600,3,150), ('Vimto','SODDA',8500,700,3,60),
('D’jino','SODDA',8000,600,3,50), ('Castel Beer','BIERE',12000,1000,3,30), ('Kadji Beer','BIERE',12000,1000,3,25), ('Mützig','BIERE',13000,1000,3,40), ('33 Export','BIERE',11500,800,3,100),
...
('Thé Vert Touareg','CHAUD',1500,500,3,200), ('Café Arabica','CHAUD',4500,1000,3,50), ('Chocolat Chaud','CHAUD',3500,1500,3,30), ('Orangina','SODDA',9000,800,3,40), ('Coca Cola 33cl','SODDA',8500,600,3,100);

DELETE FROM type_plat;
INSERT INTO type_plat (libelle) VALUES
('Plats Mitonnés'), ('Grillades Adamaoua'), ('Saveurs Forestières'), ('Cuisine Sahélienne'), ('Fruits de Mer'),
('Entrées Chaudes'), ('Entrées Froides'), ('Desserts Tropicaux'), ('Petits Déjeuners'), ('Plats du Jour'),
('Spécialités Tchad'), ('Cuisine Ouest'), ('Volailles Braisées'), ('Pâtes/Risottos'), ('Soupes/Bouillons'),
('Menu Enfant'), ('Sandwiches/Burgers'), ('Salades'), ('Accompagnements'), ('Sauces Locales'),
('Grillades Poisson'), ('Viandes Brousse'), ('Fruits Saison'), ('Pâtisseries'), ('Boissons Fraîches');

DELETE FROM plat;
INSERT INTO plat (libelle, montant, code_type, code_depot, qte_stock) VALUES
('Ndolé Royal',4500,1,1,0), ('Poulet DG Yaoundé',5500,1,1,0), ('Boule de Mil Sauce Rouge',3000,11,1,0), ('Kissar Tchadien',3500,11,1,0), ('Poisson Braisé (Bar)',6500,21,1,0),
('Achu (NW Cam)',5000,12,1,0), ('Kpem et Noix',3000,3,1,0), ('Eru et Garri',3500,3,1,0), ('Okok Sucré',3000,12,1,0), ('Soya Bœuf',2000,2,1,0),
('Kilichi Garoua',2500,2,1,0), ('Omelette Garnie',2500,9,1,0), ('Petit Déj Mirador',3500,9,1,0), ('Salade Niçoise',3500,18,1,0), ('Steak Frites',5000,10,1,0),
('Spaghetti Bolognaise',3500,14,1,0), ('Gambas Plancha',12000,5,1,0), ('Sanga Maïs',2500,3,1,0), ('Condré Porc',4500,12,1,0), ('Prunes Braisées',1500,23,1,0),
('Papaye Citron',1500,8,1,0), ('Crêpes Chocolat',2000,8,1,0), ('Soupe Pêcheur',4500,15,1,0), ('Crevettes Kribi',5500,5,1,0), ('Yassa Poulet',4500,10,1,0);

-- 6. Personnel (25 employés - Noms 100% Africains)
...
('MANGA','LOUIS','M','Camerounaise','655112233'), ('DEBY','IDRISSOU','M','Tchadienne','+235 66001122'), ('NGUEMA','MARCEL','M','Equato-Guinéenne','699778899'), ('YAMSI','CHRISTIAN','M','Camerounaise','677334455'), ('LOWE','BERNARD','M','Camerounaise','655667788');
...
('Chambre Twin', 40000, 40000, 22000, 'TWIN'), ('Suite Sahélienne', 85000, 85000, 45000, 'SAH'), ('Case VIP Cam', 110000, 110000, 70000, 'CVIP'), ('Studio Affaires', 45000, 45000, 25000, 'STA'), ('Penthouse PH1', 350000, 350000, 200000, 'PENT'),
('Bungalow Plage', 65000, 65000, 35000, 'BUN'), ('Familiale', 55000, 55000, 30000, 'FAM'), ('Chambre Éco', 15000, 15000, 10000, 'ECO'), ('Suite Royale', 250000, 250000, 150000, 'ROY'), ('Présidentielle', 500000, 500000, 300000, 'PRES'),
...
('301','301',5,'Suite J',75000), ('302','302',5,'Suite J',75000), ('303','303',6,'Suite S',100000), ('304','304',6,'Suite S',100000), ('305','305',12,'Sahélienne',85000),
('401','401',7,'VIP',150000), ('402','402',19,'Royale',250000), ('403','403',20,'Président',500000), ('501','501',9,'Appart 2P',120000), ('502','502',10,'Appart 3P',180000),
('B01','B1',16,'Bungalow',65000), ('F01','F1',17,'Familiale',55000), ('E01','E1',18,'Éco',15000), ('P01','PH1',15,'Penthouse',350000), ('W01','W1',22,'Mariage',120000);
...
-- 11. Fournisseurs (15 lignes)
DELETE FROM fournisseur;
INSERT INTO fournisseur (numero, nom, contact, solde) VALUES
('FOUR-001', 'SABC (Brasseries)', 'SABC Douala - +237 233 42 11 00', 1250000.00),
('FOUR-002', 'GUINNESS Cameroun', 'Guinness Bassa - +237 233 43 00 11', 850000.50),
('FOUR-003', 'Source du Pays', 'Tangui / Opur - +237 699 00 11 22', 450000.00),
('FOUR-004', 'SOFAVINC', 'Vins et Spiritueux - +237 242 10 20 30', 2300000.00),
('FOUR-005', 'BOCOM Gaz', 'Gaz Domestique - +237 233 41 41 41', 120000.00),
('FOUR-006', 'SCTM Gaz', 'Gaz Domestique - +237 233 40 40 40', 85000.00),
('FOUR-007', 'CHOCOCAM', 'Produits Alimentaires - +237 233 37 10 00', 350000.00),
('FOUR-008', 'SITABAC', 'Tabac et Divers - +237 233 42 22 22', 150000.00),
('FOUR-009', 'CAMLAIT', 'Produits Laitiers - +237 233 40 10 10', 280000.00),
('FOUR-010', 'SOCUCAM', 'Sucre du Cameroun - +237 222 30 30 30', 550000.00),
('FOUR-011', 'NESTELE Cameroun', 'Produits Alimentaires - +237 233 43 43 43', 900000.00),
('FOUR-012', 'SOCIETE DES EAUX (SEMC)', 'Eau Minérale - +237 233 42 42 42', 175000.00),
('FOUR-013', 'CADY SERVICES', 'Fournitures de Bureau - +237 677 88 99 00', 45000.00),
('FOUR-014', 'GLOBAL NET', 'Entretien et Nettoyage - +237 699 11 22 33', 120000.00),
('FOUR-015', 'TECH SERVICES', 'Maintenance Informatique - +237 655 44 33 22', 250000.00);
